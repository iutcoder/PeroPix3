...
export const ko: Dict = {
  ...
  settings: {
    ...
    keyGuide: {
      ...
      cenTools: { k: "1 / 2", v: "붓 · 지우개" },
      cenSize: { k: "Alt + 휠", v: "붓 크기" },
      cenUndo: { k: "Ctrl + Z", v: "한 획을 되돌립니다" },
      cenRight: { k: "우클릭", v: "이어진 덩어리를 지웁니다" },
      cenWheel: { k: "휠", v: "앞뒤 그림으로" },
    ...
    mcpCopy: "복사",
    mcpNext: "복사했습니다. 쓰시는 AI 에이전트에게 그대로 붙여 넣으세요.",
  ...
  censor: {
    ...
    tools: "도구",
    toolHint: "붓으로 칠하면 가려지고, 지우개로 지웁니다. 찾은 박스도 똑같이 지울 수 있습니다.",
    keys: "단축키",
    k_tool: "도구 바꾸기",
    k_size: "붓 크기",
    k_undo: "한 획 되돌리기",
