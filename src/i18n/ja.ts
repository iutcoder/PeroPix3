...
export const ja: Dict = {
  ...
  tagsearch: {
    title: "タグ検索",
    hint: "タグ検索: 自分の画像に使ったタグから探してプロンプトに入れる",
    close: "閉じる",
    refresh: "インデックス更新 (新規・変更された画像のみ再読込)",
    indexing: "走査中 {done}/{total}",
    error: "インデックスエラー: {msg}",
    search: "タグ検索…",
    artistOnly: "作家のみ",
    empty: "まだタグがありません。出力フォルダにプロンプト付きの画像ができるとここに集まります。",
    noHit: "該当なし",
    more: "あと {n} 件。検索語で絞ってください",
    pickHint: "押すとこのタグを使った画像を下に表示します。",
    add: "ベースの末尾に追加",
    added: "ベースに追加: {tag}",
    dup: "ベースに既にあります: {tag}",
    picked: "{tag} ({n} 枚)",
    showMore: "もっと見る",
    noPick: "タグを押すと、そのタグを使った画像がここに出ます。+ を押すとベースの末尾に入ります。",
  },
  ...
  settings: {
    ...
    keyGuide: {
      ...
      blockDrag: { k: "ブロックの取っ手をドラッグ", v: "順番を変える・ブロック保管庫に入れる・別のカードへ移す" },
      ...
      sceneRename: { k: "名前をダブルクリック", v: "シーングループ・タブの名前を変えます" },
      ...
      cenTools: { k: "1 / 2", v: "ブラシ・消しゴム" },
      cenSize: { k: "Alt + ホイール", v: "ブラシの大きさ" },
      cenUndo: { k: "Ctrl + Z", v: "一画戻します" },
      cenRight: { k: "右クリック", v: "つながった塊を消します" },
      cenWheel: { k: "ホイール", v: "前後の画像へ" },
    ...
    mcpCopy: "コピー",
    mcpNext: "コピーしました。お使いの AI エージェントにそのまま貼り付けてください。",
  ...
  censor: {
    ...
    tools: "ツール",
    toolHint: "ブラシで塗ると隠れ、消しゴムで消します。検出したボックスも同じように消せます。",
    keys: "ショートカット",
    k_tool: "ツール切替",
    k_size: "ブラシの大きさ",
    k_undo: "一画戻す",
