...
export const en = {
  ...
  settings: {
    ...
    keysTab: "Controls",
    keyGuide: {
      intro: "Controls that have no visible hint on screen.",
      group: { prompt: "Prompt · chips", scene: "Scenes · images", gallery: "Gallery", censor: "Censor", files: "File manager", window: "Window" },
      chipDelete: { k: "Right-click a chip", v: "Removes the chip (Ctrl+Z to undo)" },
      chipWeight: { k: "Alt + wheel", v: "Changes the weight by 0.05 over a chip" },
      chipWeightBig: { k: "Alt + Shift + wheel", v: "Changes the weight by 0.1" },
      chipReset: { k: "Middle-click", v: "Resets the chip weight to 1" },
      chipDrag: { k: "Drag a chip", v: "Moves it within the block, to another block, or to another card" },
      blockDrag: { k: "Drag the block handle", v: "Reorders, drops into the block library, or moves to another card" },
      editEnter: { k: "Enter", v: "Saves and leaves the editor" },
      editShiftEnter: { k: "Shift + Enter", v: "Saves and starts a new block right after" },
      editTab: { k: "Tab / Shift + Tab", v: "Moves to the next / previous block" },
      editEsc: { k: "Esc", v: "Cancels the edit" },
      editUndo: { k: "Ctrl + Z (while editing)", v: "Undo inside the text box" },
      pickMulti: { k: "Ctrl + click", v: "Picks several images in the scene lane" },
      pickRange: { k: "Shift + click", v: "Picks a range" },
      pickDelete: { k: "Delete / Backspace", v: "Sends the picked images to the trash" },
      pickClear: { k: "Esc", v: "Clears the pick" },
      arrowTake: { k: "← →", v: "Previous / next image (↑ ↓ in vertical mode)" },
      arrowScene: { k: "↑ ↓", v: "Another scene (← → in vertical mode)" },
      ...
      undo: { k: "Ctrl + Z", v: "Undoes the last edit (chip removal, weight, image deletion, assistant changes)" },
      galArrows: { k: "← →", v: "Previous / next image" },
      galStar: { k: "S", v: "Toggles the star" },
      galMulti: { k: "Ctrl + click", v: "Picks several images" },
      galRename: { k: "Double-click a name", v: "Renames the file" },
      galClose: { k: "Click beside the image", v: "Closes the large view" },
      cenTools: { k: "1 / 2", v: "Brush · eraser" },
      cenSize: { k: "Alt + wheel", v: "Brush size" },
      cenUndo: { k: "Ctrl + Z", v: "Undoes one stroke" },
      cenRight: { k: "Right-click", v: "Deletes the connected blob" },
      cenWheel: { k: "Wheel", v: "Previous / next image" },
      cenArrows: { k: "← →", v: "Previous / next image" },
  ...
  censor: {
    ...
    needBox: "Nothing has been painted.",
    ...
    tools: "Tools",
    toolHint: "Paint to cover, erase to uncover. Detected boxes can be erased the same way.",
    keys: "Shortcuts",
    k_tool: "Switch tool",
    k_size: "Brush size",
    k_undo: "Undo one stroke",
    k_wheelKey: "Wheel",
    k_wheel: "Next image",
  ...
  scenes: {
    ...
    destBase: "Insert into base",
    destChar: "Insert into character · {name}",
    destAll: "Insert into all characters",
    destHint: "Where the scene card's prompt is inserted when generating. Base = after the shared prompt for the whole image · Character = after that character's prompt · All = after every enabled character",
