...
export const en = {
  ...
  settings: {
    ...
    keyGuide: {
      ...
      cenTools: { k: "1 / 2 / 3", v: "Select · add · delete tool" },
      cenDelete: { k: "Delete", v: "Removes the selected box" },
      cenRight: { k: "Right-click a box", v: "Removes that box" },
